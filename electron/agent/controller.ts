    ...
    modes: [
      {
        ...
        instructions: [
          ...
          "Scene minDurationSec/maxDurationSec bound the RAW recording, which includes the",
          "recording agent's think-time between actions — omit them for the defaults, or set",
          "a generous max (60-120s); never tight final-video pacing like [3, 6].",
